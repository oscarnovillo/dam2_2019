...
public class Members {
    ...
    private Student studentByIdmember;
    ...
    public Student getStudentByIdmember() {
        return studentByIdmember;
    }

    public void setStudentByIdmember(Student studentByIdmember) {
        this.studentByIdmember = studentByIdmember;
    }
